...
### Back-End - Autenticação & Segurança
 - [x] **Implementar JWT** - Autenticação com tokens
 - [x] **Hash de Senhas** - bcrypt ou similar
 - [x] **CORS** - Configurar acesso front-end
 - [x] **Validações** - Validar dados em todas as rotas
 - [x] **Tratamento de Erros** - Erros padronizados

### Back-End - Rotas
 - [x] **POST /api/usuarios/register** - Registrar novo usuário
 - [x] **POST /api/usuarios/login** - Login
 - [x] **GET /api/produtos** - Listar produtos
 - [x] **GET /api/produtos/:id** - Detalhes do produto
 - [x] **POST /api/pedidos** - Criar pedido
 - [x] **GET /api/pedidos/:id** - Detalhes do pedido
 - [x] **GET /api/usuarios/:id/pedidos** - Pedidos do usuário

### Testes
 - [x] **Testes Unitários** - Funções individuais
 - [x] **Testes de Integração** - APIs completas
 - [x] **Testes E2E** - Fluxo completo do usuário (Manual/Script)

### DevOps & Deploy
 - [x] **Docker** - Containerizar aplicação
 - [x] **Deploy** - Scripts de produção prontos
